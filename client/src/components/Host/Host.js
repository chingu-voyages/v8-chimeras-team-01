  ...
  render() {
    ...
    return (
      <div id="host-container">
        ...
        {(!!this.state.readyLeaderBoard) && <button class="host-next__btn" onClick={this.goLeaderboard}>Leaderboard</button>}
        {(!!this.state.readyResults) && <button class="host-next__btn" onClick={this.goResults}>results</button>}
